      ...
      <div class="bg-gradient-to-b from-[#101212] relative to-[#08201D]">
        ...
        <div className="relative w-full overflow-x-hidden">
          <div
            ...
            style={{ animation: "scrollLogo 20s linear infinite" }}
          >
            {/* Duplicate the logos to create a seamless repeating effect */}
            {[...Array(2)].map((_, index) => (
              <div key={index} className="flex">
                {/* Example logos - replace these with the actual logos */}
                <img src="/logo1.png" alt="Logo 1" className="h-12 mx-4" />
                <img src="/logo2.png" alt="Logo 2" className="h-12 mx-4" />
                <img src="/logo3.png" alt="Logo 3" className="h-12 mx-4" />
                {/* Repeat as necessary */}
              </div>
            ))}
          </div>
